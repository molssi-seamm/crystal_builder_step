...
do
	...
	sphinx-apidoc -o docs/developer crystal_builder_step
...
<html>
   <head>
      <title>Documentation for the Crystal Builder plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Crystal Builder plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
